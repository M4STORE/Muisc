...
async def jiosaavn(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/4414421c401a9b604267b.jpg",
        caption=f"#️⃣ Your requested song queued at position {position}.",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Join Updates Channel", url="https://t.me/ZauTeKm")]]
        ),
        parse_mode="markdown") 
        await res.delete()
    else:
        ...
        await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"▶️ Playing `{sname}` Via [JioSaavn](https://t.me/zauteMusic)",
        photo="https://telegra.ph/file/4414421c401a9b604267b.jpg",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("Join Updates Channel", url="https://t.me/ZauTeKm")]]
        ),
